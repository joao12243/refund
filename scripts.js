...
form.onsubmit = (event) => {
  // Previne o comportamento de carregar a página.
...
function expenseAdd(newExpense) {
  try {
    // Cria o elemento de li para dicionar o item na lista (ul).
    ...
    // Adiciona o nome e categoria da div das informmações da despesa.
